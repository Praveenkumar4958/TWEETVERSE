...
<head>
  ...
  <title>
    ...
    <?php echo $profileData->username; ?>) | Twitter
  </title>
    ...
    <div class="wrapper-left">
      <div class="sidebar-left">
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align position-relative">
              <?php if ($notify_count > 0) { ?>
                <i class="notify-count">
                  <?php echo $notify_count; ?>
                </i>
              <?php } ?>
              <img src="<?php echo BASE_URL . "/includes/icons/tweetnotif.png"; ?>" alt="" height="26.25px"
                width="26.25px" />
            </div>
        ...
        <a href="<?php echo BASE_URL . "account.php"; ?>">
          <div class="grid-sidebar ">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/includes/icons/tweetsetting.png"; ?>" alt="" height="26.25px"
                width="26.25px" />
            </div>
        ...
        <!-- Button for integrating with more apps -->
        <button class="button-twittear button-tooltip">
          <strong>MORE FEATURES</strong>
          <div class="tooltip-content">
            <ul class="integration-list">
              <li>
                <a href="Language_ Translater\index.html">
              ...
              <li>
                <a href="IMG-EDITOR\index.html">
                  <i class="fas fa-image"></i>
                  <span>Edit Image</span>
                </a>
              </li>
              <li>
                <a href="Text To Speech Converter\index.html">
          ...
          <div class="container">
            ...
            <div class="row home-loc-link ml-2">
              <?php if (!empty($profileData->location)) { ?>
                <div class="col-md-4">
                  <li class=""> <i class="fas fa-map-marker-alt"></i>
            ...
            <div class="row home-follow ml-2 mt-1">
              <div class="col-md-3">
                <div class="count-following-i" data-follow="<?php echo $profileData->id; ?>">
                  <span class="home-follow-count count-following">
                    <?php echo Follow::countFollowing($profileData->id); ?>
                  </span> Followings
                </div>
              </div>
              <div class="col-md-3">
                <div class="count-followers-i" data-follow="<?php echo $profileData->id; ?>">
                  <span class="home-follow-count count-followers">
                    <?php echo Follow::countFollowers($profileData->id); ?>
                  </span> Followers
                </div>
              </div>
            </div>
            ...
            <div class="grid-share">
              ...
              <div>
                <button class="follow-btn follow-btn-m 
                  ...
                  data-user="<?php echo $user_id; ?>" data-profile="<?php echo $profileData->id; ?>"
